...
```
                      passages   resources   subject resolution   crops   districts
OCR off                    29           6                24.1%       8          41
OCR on                    103          12                61.2%      26          41
```
...
.venv/bin/pytest tests/test_v4.py -q -m "not semantic and not ocr"  # 47 passed, 55s
